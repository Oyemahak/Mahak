...
const WorkedFor = () => {
  // Prefix for GitHub Pages base path
      ...
      <div className="worked-for-container">
        <div className="worked-for-grid">
          <div className="company-14 tooltip">
            <img src={`${base}assets/images/company1.png`} alt="Citi Bank" />
          ...
          <div className="company-23 tooltip">
            <img src={`${base}assets/images/company2.png`} alt="Accenture" />
            <span className="tooltiptext">
          ...
          <div className="company-23 tooltip">
            <img src={`${base}assets/images/company3.png`} alt="Dazzling Smiles" />
            <span className="tooltiptext">
          ...
          <div className="company-14 tooltip">
            <img src={`${base}assets/images/company4.png`} alt="CanSTEM Education" />
            <span className="tooltiptext">
        ...
        <div className="carousel-arrows">
          ...
          <div className="worked-for-mobile">
            <img className="mobile-companies-img" src={`${base}assets/images/accenture.png`} alt="Accenture" />
            <img className="mobile-companies-img active" src={`${base}assets/images/citi.png`} alt="Citi Bank" />
            <img className="mobile-companies-img" src={`${base}assets/images/dazzling-smile.png`} alt="Dazzling Smiles" />
            <img className="mobile-companies-img" src={`${base}assets/images/canstem.png`} alt="CanSTEM Education" />
          </div>
